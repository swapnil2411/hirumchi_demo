...
$vf_config = array(
     ...
     */
    'emailRecipients' => 'info@hirumchi.com',
     ...
     * If s/o, leave this field as empty.
     * E.g. Single recipient
     * 'emailSender' => 'john@domain.com',
     */
    'emailSender' => 'ashufd557@gmail.com'
    /*** /Code Snippet - quick-start ***/
);
...
$subject = 'Hirumchi Contact Form - New Message from '.$vfSender->data['name'];
